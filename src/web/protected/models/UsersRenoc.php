...
/**
 * This is the model class for table "users_renoc".
 *
 * The followings are the available columns in table 'users_renoc':
 * @property integer $id
 ...
 * @property ProfilesRenoc[] $profilesRenocs
 */
class UsersRenoc extends CActiveRecord
{
	 ...
	 * @return UsersRenoc the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			...
			'profilesRenocs' => array(self::HAS_MANY, 'ProfilesRenoc', 'id_users_renoc'),
		);
	}
