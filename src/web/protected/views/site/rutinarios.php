    ...
    <body>
        <div class="capaOculta">
            ...
            <div  id="atras"><ul class="thumbnails">
                    <li class="span1">
                        <div id="icono" >
                            <h1> <a id="flecha-backward" href="/" class="tooltip-test"><</a></h1>
                        </div>
                    </li>
                </ul> 
            </div>
            <div class="Rotate-90 hidden-phone hidden-tablet">RUTINARIOS</div>
            <div id="barraVerde1" class="span2 hidden-phone" >
            </div> 
            <form id="formRutinarios" name="formRutinarios" >
            ...
            <div id="tablagris" class="span2" >
                ...
                <table>
                    ...
                    <tr> 
                        ...
                        <td>
                            <input type="hidden" id="datepicker_value" name="datepicker_value"/>                                        
                        </td></tr>
                </table>
