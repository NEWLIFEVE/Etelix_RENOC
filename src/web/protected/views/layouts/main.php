...
<body>
    ...
    <!-- fin de contenido-->
    <div id="footer">
        Copyright &copy; <?php echo date('Y'); ?> SACET All Rights Reserved. Version 1.3.19.3
    </div>
    <div class="clear"></div>
...
<body>
    ...
    <!-- fin de contenido-->
    <div id="footer">
        Copyright &copy; <?php echo date('Y'); ?> SACET All Rights Reserved. Version 1.3.20.2
    </div>
    <div class="clear"></div>
    <div class='cargandosori'>
        <h6>
...
>>>>>>> ebb486fe4a92a057ff2b724984828178c2e3d5ca
