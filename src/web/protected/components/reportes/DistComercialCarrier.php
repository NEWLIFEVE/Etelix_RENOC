...
* @package reportes
*/
class DistComercialCarrier extends Reportes
{
	/**
...
ORDER BY operador ASC, vendedor ASC, id_tp ASC";
        $cuerpo="<table >
                    <thead>
                        <tr>
        ...
        if($vendedores!=null)
        {
            ...
            foreach ($vendedores as $key => $vendedor)
            {
                ...
                $cuerpo.="<tr>
                            <td style='".self::colorCarrier($vendedor->operador)."'>".$posicion."</td>
                            <td style='".self::colorCarrier($vendedor->operador)."'>".$nombreV."</td>
                            <td style='".self::colorCarrier($vendedor->operador)."'>".$numero."</td>
                            <td style='".self::colorCarrier($vendedor->operador)."'>".$nombre."</td>
                            <td style='".self::colorCarrier($vendedor->operador,$vendedor->company)."'>".$vendedor->company."</td>
                            <td style='text-align: right;".self::colorCarrier($vendedor->operador,$vendedor->termino_pago)."'>(".$vendedor->termino_pago.")</td>
                            <td style='".self::colorCarrier($vendedor->operador,$vendedor->monetizable)."'>".$vendedor->monetizable."</td>
                            <td style='".self::colorCarrier($vendedor->operador,NULL,$vendedor->dias_disputa)."'>".$vendedor->dias_disputa."</td>
                            <td style='".self::colorCarrier($vendedor->operador,NULL,$vendedor->limite_credito)."'>".$vendedor->limite_credito."</td>
                            <td style='".self::colorCarrier($vendedor->operador,NULL,$vendedor->limite_compra)."'>".$vendedor->limite_compra."</td>
                        </tr>";
            } 
        }
        else
