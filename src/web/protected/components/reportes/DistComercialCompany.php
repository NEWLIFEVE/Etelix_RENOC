...
* @package reportes
*/
class DistComercialCompany extends Reportes
{
	/**
...
ORDER BY company ASC,vendedor ASC, id_tp ASC";
        $cuerpo="<table >
                    <thead>
                        <tr>
        ...
        if($vendedores!=null)
        {
            ...
            foreach ($vendedores as $key => $vendedor)
            {
                ...
                $cuerpo.="<tr>
                            <td style='".self::colorCom($vendedor->company)."'>".$posicion."</td>
                            <td style='".self::colorCom($vendedor->company)."'>".$nombreV."</td>
                            <td style='".self::colorCom($vendedor->company)."'>".$numero."</td>
                            <td style='".self::colorCom($vendedor->company)."'>".$vendedor->operador."</td>
                            <td style='".self::colorCom($vendedor->company,$vendedor->company)."'>".$nombre."</td>
                            <td style='text-align: right;".self::colorCom($vendedor->company,$vendedor->termino_pago)."'>(".$vendedor->termino_pago.")</td>
                            <td style='".self::colorCom($vendedor->company,$vendedor->monetizable)."'>".$vendedor->monetizable."</td>
                            <td style='".self::colorCom($vendedor->company,NULL,$vendedor->dias_disputa)."'>".$vendedor->dias_disputa."</td>
                            <td style='".self::colorCom($vendedor->company,NULL,$vendedor->limite_credito)."'>".$vendedor->limite_credito."</td>
                            <td style='".self::colorCom($vendedor->company,NULL,$vendedor->limite_compra)."'>".$vendedor->limite_compra."</td>
                        </tr>";
            } 
        }
        else
