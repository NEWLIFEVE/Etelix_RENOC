...
* @package reportes
*/
class DistComercialMonetizable extends Reportes
{
	/**
...
ORDER BY id_mon ASC,vendedor ASC, id_tp ASC";
        $cuerpo="<table >
                    <thead>
                        <tr>
        ...
        if($vendedores!=null)
        {
            ...
            foreach ($vendedores as $key => $vendedor)
            {
                ...
                $cuerpo.="<tr>
                            <td style='".self::colorM($vendedor->monetizable)."'>".$posicion."</td>
                            <td style='".self::colorM($vendedor->monetizable)."'>".$nombreV."</td>
                            <td style='".self::colorM($vendedor->monetizable)."'>".$numero."</td>
                            <td style='".self::colorM($vendedor->monetizable)."'>".$vendedor->operador."</td>
                            <td style='".self::colorM($vendedor->monetizable,$vendedor->company)."'>".$vendedor->company."</td>
                            <td style='text-align: right;".self::colorM($vendedor->monetizable,$vendedor->termino_pago)."'>(".$vendedor->termino_pago.")</td>
                            <td style='".self::colorM($vendedor->monetizable,$vendedor->monetizable)."'>".$nombre."</td>
                            <td style='".self::colorM($vendedor->monetizable,NULL,$vendedor->dias_disputa)."'>".$vendedor->dias_disputa."</td>
                            <td style='".self::colorM($vendedor->monetizable,NULL,$vendedor->limite_credito)."'>".$vendedor->limite_credito."</td>
                            <td style='".self::colorM($vendedor->monetizable,NULL,$vendedor->limite_compra)."'>".$vendedor->limite_compra."</td>
                        </tr>";
            } 
        }
        else
